        ...
        <div className="flex flex-row flex-wrap md:w-full">
          <div className="w-full px-4 mb-10 sm:w-1/2">
            ...
            <p className="text-slate-500 text-base max-w-xl text-justify md:indent-5 md:text-justify indent-2">
              Experienced build web with MERN Stack. Im have experienced intern
              at government ministry of home affairs ditjen bina bangda as an IT
              Support & Web Developer. Im experince on bootcamp at collage Bina
              Sarana Informatika University on theme Software Devlopment with
              Native Php, Bootstrap, MySQL. Im to contribute on bootcamp at
              <a
              ...
              x{" "}
              <a
                href="https://www.dbs.com/foundation/index.html"
                className="text-gray-950 font-semibold"
                target="_blank"
              >
                DBS foundation
              </a>{" "}
              in role Full-Stack Web Developer, in bootcamp i contribute on
          ...
          <div className="w-full px-4 mb-10 sm:w-1/2">
            ...
            <div className="flex flex-wrap items-center">
              {/* instagram */}
              <a
                href="https://instagram.com/muhhfrhnnn"
                target="_blank"
              ...
              {/* whatsapp */}
              <a
                href="https://wa.me/62895326257069?text=Halo%20Farhan%20saya%20ingin%20bertanya%20tentang%20portofolio%20anda"
                target="_blank"
                className="w-9 h-9 mr-3 mb-1 rounded-full flex justify-center items-center border border-slate-300 hover:border-sky-500 hover:bg-sky-600 hover:text-white transition duration-500 ease-in-out text-slate-500"
                onClick={(e) => e.preventDefault()}
              >
              ...
              {/* git */}
              <a
                href="https://github.com/muhhfarhann"
                target="_blank"
                className="w-9 h-9 mr-3 mb-1 rounded-full flex justify-center items-center border border-slate-300 hover:border-sky-500 hover:bg-sky-600 hover:text-white transition duration-500 ease-in-out text-slate-500"
                onClick={(e) => e.preventDefault()}
              >
              ...
              {/* email */}
              <a
                href="mailto:mf333285@gmail.com?subject=Hi%20Farhan&body=Hello%20Farhan"
                target="_blank"
                className="w-9 h-9 mr-3 mb-1 rounded-full flex justify-center items-center border border-slate-300 hover:border-sky-500 hover:bg-sky-600 hover:text-white transition duration-500 ease-in-out text-slate-500"
                onClick={(e) => e.preventDefault()}
              >
          ...
          <div className="education rounded-2xl border border-slate-200 bg-white/80 shadow-sm backdrop-blur p-5">
            ...
            <div className="grid grid-cols-2 gap-y-2 text-xs sm:text-sm">
              ...
              <div className="text-slate-700">3.47</div>
